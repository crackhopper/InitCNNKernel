...
class ConvNet(CustomNetwork):
  def setup(self):
    ...
    (self.net_def
     .conv2d([5, 5], 64, [1,1], name='conv1') # (1, 32, 32, 64)
     .maxpool([3, 3], [2,2] , name='pool1') # (1, 16, 16, 64)
     .lrn(2, 2e-05, 0.75, name='norm1')
     .conv2d([5,5], 32, [1,1], name='conv2') #(1, 16, 16, 32)
     .maxpool([3, 3], [2, 2],  name='pool2') # (1, 8, 8, 32)
     .lrn(2, 2e-05, 0.75, name='norm2')
     .conv2d([3, 3], 32, [1, 1], name='conv3') # (1, 8, 8, 32)
     .conv2d([3, 3], 16, [1, 1], name='conv4') # (1, 8, 8, 16)
     .conv2d([3, 3], 8, [1, 1], name='conv5') # (1, 8, 8, 8)
     .maxpool([3, 3], [2, 2], name='pool5') # (1, 4, 4, 8)
     .fc(64, name='fc6')
     .fc(64, name='fc7')
